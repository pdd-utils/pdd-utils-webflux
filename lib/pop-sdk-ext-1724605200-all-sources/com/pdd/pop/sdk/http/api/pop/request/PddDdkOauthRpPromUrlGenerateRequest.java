...
public class PddDdkOauthRpPromUrlGenerateRequest extends PopBaseHttpRequest<PddDdkOauthRpPromUrlGenerateResponse> {
     ...
     * 大促会场集合页参数
     */
    @JsonProperty("diy_promo_act_collection_param")
    private DiyPromoActCollectionParam diyPromoActCollectionParam;
    ...
    protected void setUserParams(Map<String, String> params) {
        ...
        setUserParam(params, "diy_promo_act_collection_param", diyPromoActCollectionParam);
    ...
    public void setDiyPromoActCollectionParam(DiyPromoActCollectionParam diyPromoActCollectionParam) {
        this.diyPromoActCollectionParam = diyPromoActCollectionParam;
    }
    ...
    public static class DiyPromoActCollectionParam {
