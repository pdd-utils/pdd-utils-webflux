...
import com.pdd.pop.sdk.http.api.pop.response.PddVasMultimallUpdateResponse;
...
public class PddVasMultimallUpdateRequest extends PopBaseHttpRequest<PddVasMultimallUpdateResponse> {
    ...
    public String getType() {
        return "pdd.vas.multimall.update";
    }
    ...
    @Override
    public Class<PddVasMultimallUpdateResponse> getResponseClass() {
        return PddVasMultimallUpdateResponse.class;
    }
