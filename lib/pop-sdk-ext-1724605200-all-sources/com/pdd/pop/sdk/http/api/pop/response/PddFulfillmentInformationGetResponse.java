...
public class PddFulfillmentInformationGetResponse extends PopBaseHttpResponse {

    /**
     * 
     */
    @JsonProperty("fulfillment_info_get_response")
    private FulfillmentInfoGetResponse fulfillmentInfoGetResponse;

    public FulfillmentInfoGetResponse getFulfillmentInfoGetResponse() {
        return fulfillmentInfoGetResponse;
    }

    public static class FulfillmentInfoGetResponse {

        /**
         * 详情信息
         */
        @JsonProperty("fulfillment_info")
        private FulfillmentInfoGetResponseFulfillmentInfo fulfillmentInfo;

        public FulfillmentInfoGetResponseFulfillmentInfo getFulfillmentInfo() {
            return fulfillmentInfo;
        }
    }

    public static class FulfillmentInfoGetResponseFulfillmentInfo {
        ...
        private FulfillmentInfoGetResponseFulfillmentInfoDoorToDoorCollectInfo doorToDoorCollectInfo;
        ...
        private List<FulfillmentInfoGetResponseFulfillmentInfoFulfillmentTagListItem> fulfillmentTagList;
        ...
        public FulfillmentInfoGetResponseFulfillmentInfoDoorToDoorCollectInfo getDoorToDoorCollectInfo() {
        ...
        public List<FulfillmentInfoGetResponseFulfillmentInfoFulfillmentTagListItem> getFulfillmentTagList() {
    ...
    public static class FulfillmentInfoGetResponseFulfillmentInfoDoorToDoorCollectInfo {
    ...
    public static class FulfillmentInfoGetResponseFulfillmentInfoFulfillmentTagListItem {
