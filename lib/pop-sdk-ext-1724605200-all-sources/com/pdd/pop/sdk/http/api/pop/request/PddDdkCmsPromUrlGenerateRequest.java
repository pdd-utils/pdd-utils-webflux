...
public class PddDdkCmsPromUrlGenerateRequest extends PopBaseHttpRequest<PddDdkCmsPromUrlGenerateResponse> {
    ...
    private Integer countryRegionCode;
    ...
    protected void setUserParams(Map<String, String> params) {
        ...
        setUserParam(params, "country_region_code", countryRegionCode);
        ...
        setUserParam(params, "language_code", languageCode);
    ...
    public void setCountryRegionCode(Integer countryRegionCode) {
