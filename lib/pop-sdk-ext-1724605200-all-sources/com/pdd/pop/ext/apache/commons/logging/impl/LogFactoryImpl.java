 ...
 *     <code>com.pdd.pop.ext.apache.commons.logging.Log</code> to identify the
 *     requested implementation class.</li>
 * <li>Use the <code>com.pdd.pop.ext.apache.commons.logging.Log</code> system property
 *     to identify the requested implementation class.</li>
 * <li>If <em>Log4J</em> is available, return an instance of
 *     <code>com.pdd.pop.ext.apache.commons.logging.impl.Log4JLogger</code>.</li>
 * <li>If <em>JDK 1.4 or later</em> is available, return an instance of
 *     <code>com.pdd.pop.ext.apache.commons.logging.impl.Jdk14Logger</code>.</li>
 * <li>Otherwise, return an instance of
 *     <code>com.pdd.pop.ext.apache.commons.logging.impl.SimpleLog</code>.</li>
 * </ul>
 * <p>
...
public class LogFactoryImpl extends LogFactory {
    ...
    private static final String LOGGING_IMPL_LOG4J_LOGGER = "com.pdd.pop.ext.apache.commons.logging.impl.Log4JLogger";
    /** Jdk14Logger class name */
    private static final String LOGGING_IMPL_JDK14_LOGGER = "com.pdd.pop.ext.apache.commons.logging.impl.Jdk14Logger";
    /** Jdk13LumberjackLogger class name */
    private static final String LOGGING_IMPL_LUMBERJACK_LOGGER =
            "com.pdd.pop.ext.apache.commons.logging.impl.Jdk13LumberjackLogger";

    /** SimpleLog class name */
    private static final String LOGGING_IMPL_SIMPLE_LOGGER = "com.pdd.pop.ext.apache.commons.logging.impl.SimpleLog";

    private static final String PKG_IMPL="com.pdd.pop.ext.apache.commons.logging.impl.";
    ...
    /**
     * The name (<code>com.pdd.pop.ext.apache.commons.logging.Log</code>) of the system
     * property identifying our {@link Log} implementation class.
     */
    public static final String LOG_PROPERTY = "com.pdd.pop.ext.apache.commons.logging.Log";

    /**
     * The deprecated system property used for backwards compatibility with
     * old versions of JCL.
     */
    protected static final String LOG_PROPERTY_OLD = "com.pdd.pop.ext.apache.commons.logging.log";

    /**
     * The name (<code>com.pdd.pop.ext.apache.commons.logging.Log.allowFlawedContext</code>)
    ...
    public static final String ALLOW_FLAWED_CONTEXT_PROPERTY =
        "com.pdd.pop.ext.apache.commons.logging.Log.allowFlawedContext";

    /**
     * The name (<code>com.pdd.pop.ext.apache.commons.logging.Log.allowFlawedDiscovery</code>)
     * of the system property which can be set true/false to
    ...
    public static final String ALLOW_FLAWED_DISCOVERY_PROPERTY =
        "com.pdd.pop.ext.apache.commons.logging.Log.allowFlawedDiscovery";

    /**
     * The name (<code>com.pdd.pop.ext.apache.commons.logging.Log.allowFlawedHierarchy</code>)
     * of the system property which can be set true/false to
    ...
    public static final String ALLOW_FLAWED_HIERARCHY_PROPERTY =
        "com.pdd.pop.ext.apache.commons.logging.Log.allowFlawedHierarchy";
    ...
    private static final String[] classesToDiscover = {
            ...
            "com.pdd.pop.ext.apache.commons.logging.impl.Jdk14Logger",
            "com.pdd.pop.ext.apache.commons.logging.impl.Jdk13LumberjackLogger",
            "com.pdd.pop.ext.apache.commons.logging.impl.SimpleLog"
    };
    ...
    /**
     * The {@link com.pdd.pop.ext.apache.commons.logging.Log} instances that have
     ...
     * {@link com.pdd.pop.ext.apache.commons.logging.Log}
     ...
     * {@link com.pdd.pop.ext.apache.commons.logging.Log} method, if it exists.
     */
     ...
     * new {@link com.pdd.pop.ext.apache.commons.logging.Log} instances.</p>
     *
    ...
    /**
     * Create and return a new {@link com.pdd.pop.ext.apache.commons.logging.Log}
