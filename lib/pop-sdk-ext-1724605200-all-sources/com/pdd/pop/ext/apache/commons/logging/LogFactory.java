...
public abstract class LogFactory {
    ...
    /**
     * The name (<code>com.pdd.pop.ext.apache.commons.logging.LogFactory</code>) of the property
     * used to identify the LogFactory implementation
     * class name. This can be used as a system property, or as an entry in a
     * configuration properties file.
     */
    public static final String FACTORY_PROPERTY = "com.pdd.pop.ext.apache.commons.logging.LogFactory";

    /**
     * The fully qualified class name of the fallback <code>LogFactory</code>
     * implementation class to use, if no other can be found.
     */
    public static final String FACTORY_DEFAULT = "com.pdd.pop.ext.apache.commons.logging.impl.LogFactoryImpl";
    ...
    protected static final String SERVICE_ID =
        "META-INF/services/com.pdd.pop.ext.apache.commons.logging.LogFactory";

    /**
     * The name (<code>com.pdd.pop.ext.apache.commons.logging.diagnostics.dest</code>)
    ...
    public static final String DIAGNOSTICS_DEST_PROPERTY =
        "com.pdd.pop.ext.apache.commons.logging.diagnostics.dest";
     ...
     * (<code>com.pdd.pop.ext.apache.commons.logging.LogFactory.HashtableImpl</code>)
     ...
     *     ...
     *     &lt;sysproperty
     *        key="com.pdd.pop.ext.apache.commons.logging.LogFactory.HashtableImpl"
     *        value="com.pdd.pop.ext.apache.commons.logging.AltHashtable"/&gt;
     *  &lt;/java&gt;
     * </pre>
     * will mean that <code>LogFactory</code> will load an instance of
     * <code>com.pdd.pop.ext.apache.commons.logging.AltHashtable</code>.
     * <p>
    ...
    public static final String HASHTABLE_IMPLEMENTATION_PROPERTY =
        "com.pdd.pop.ext.apache.commons.logging.LogFactory.HashtableImpl";

    /** Name used to load the weak hashtable implementation by names. */
    private static final String WEAK_HASHTABLE_CLASSNAME =
        "com.pdd.pop.ext.apache.commons.logging.impl.WeakHashtable";
     ...
     * <p>
     * <ul>
     * <li>The <code>com.pdd.pop.ext.apache.commons.logging.LogFactory</code> system
     *     property.</li>
     ...
     *     (<code>com.pdd.pop.ext.apache.commons.logging.impl.LogFactoryImpl</code>).</li>
     * </ul>
     * <p>
            ...
            try {
                ...
                if (logFactoryClassLoader == null) {
                    ...
                    Class factoryFromCustomLoader
                        = Class.forName("com.pdd.pop.ext.apache.commons.logging.LogFactory", false, logFactoryClassLoader);
