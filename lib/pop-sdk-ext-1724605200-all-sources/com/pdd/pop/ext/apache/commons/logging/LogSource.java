...
package com.pdd.pop.ext.apache.commons.logging;

import java.lang.reflect.Constructor;
import java.util.Hashtable;

import com.pdd.pop.ext.apache.commons.logging.impl.NoOpLog;
 ...
 *     <code>com.pdd.pop.ext.apache.commons.logging.impl.NoOpLog</code>.</li>
 * </ul>
 * <p>
 * You can change the default behavior in one of two ways:
 * <ul>
 * <li>On the startup command line, set the system property
 *     <code>com.pdd.pop.ext.apache.commons.logging.log</code> to the name of the
 *     <code>com.pdd.pop.ext.apache.commons.logging.Log</code> implementation class
 *     you want to use.</li>
...
public class LogSource {
    ...
    static {
        ...
        // Is Log4J Available?
        try {
            log4jIsAvailable = null != Class.forName("com.pdd.pop.ext.apache.log4j.Logger");
        } catch (Throwable t) {
        ...
        try {
            jdk14IsAvailable = null != Class.forName("java.util.logging.Logger") &&
                               null != Class.forName("com.pdd.pop.ext.apache.commons.logging.impl.Jdk14Logger");
        } catch (Throwable t) {
        ...
        String name = null;
        try {
            name = System.getProperty("com.pdd.pop.ext.apache.commons.logging.log");
            if (name == null) {
                name = System.getProperty("com.pdd.pop.ext.apache.commons.logging.Log");
            }
        } catch (Throwable t) {
        ...
        if (name != null) {
            try {
                ...
                try {
                    setLogImplementation("com.pdd.pop.ext.apache.commons.logging.impl.NoOpLog");
                } catch (Throwable u) {
                    // ignored
                }
            }
            ...
            try {
                if (log4jIsAvailable) {
                    setLogImplementation("com.pdd.pop.ext.apache.commons.logging.impl.Log4JLogger");
                } else if (jdk14IsAvailable) {
                    setLogImplementation("com.pdd.pop.ext.apache.commons.logging.impl.Jdk14Logger");
                } else {
                    setLogImplementation("com.pdd.pop.ext.apache.commons.logging.impl.NoOpLog");
                }
            } catch (Throwable t) {
     ...
     * value of the <tt>com.pdd.pop.ext.apache.commons.logging.log</tt> property. The value
     * of <tt>com.pdd.pop.ext.apache.commons.logging.log</tt> may be set to the fully specified
     ...
     * <p>
     * When <tt>com.pdd.pop.ext.apache.commons.logging.log</tt> is not set, or when no corresponding
