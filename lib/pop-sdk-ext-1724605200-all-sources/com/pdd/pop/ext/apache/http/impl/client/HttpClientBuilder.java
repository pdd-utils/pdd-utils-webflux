...
import com.pdd.pop.ext.apache.http.ConnectionReuseStrategy;
import com.pdd.pop.ext.apache.http.Header;
import com.pdd.pop.ext.apache.http.HttpHost;
import com.pdd.pop.ext.apache.http.HttpRequestInterceptor;
import com.pdd.pop.ext.apache.http.HttpResponseInterceptor;
import com.pdd.pop.ext.apache.http.auth.AuthSchemeProvider;
import com.pdd.pop.ext.apache.http.client.AuthenticationStrategy;
import com.pdd.pop.ext.apache.http.client.BackoffManager;
import com.pdd.pop.ext.apache.http.client.ConnectionBackoffStrategy;
import com.pdd.pop.ext.apache.http.client.CookieStore;
import com.pdd.pop.ext.apache.http.client.CredentialsProvider;
import com.pdd.pop.ext.apache.http.client.HttpRequestRetryHandler;
import com.pdd.pop.ext.apache.http.client.RedirectStrategy;
import com.pdd.pop.ext.apache.http.client.ServiceUnavailableRetryStrategy;
import com.pdd.pop.ext.apache.http.client.UserTokenHandler;
import com.pdd.pop.ext.apache.http.client.config.AuthSchemes;
import com.pdd.pop.ext.apache.http.client.config.RequestConfig;
import com.pdd.pop.ext.apache.http.client.entity.InputStreamFactory;
import com.pdd.pop.ext.apache.http.client.protocol.RequestAcceptEncoding;
import com.pdd.pop.ext.apache.http.client.protocol.RequestAddCookies;
import com.pdd.pop.ext.apache.http.client.protocol.RequestAuthCache;
import com.pdd.pop.ext.apache.http.client.protocol.RequestClientConnControl;
import com.pdd.pop.ext.apache.http.client.protocol.RequestDefaultHeaders;
import com.pdd.pop.ext.apache.http.client.protocol.RequestExpectContinue;
import com.pdd.pop.ext.apache.http.client.protocol.ResponseContentEncoding;
import com.pdd.pop.ext.apache.http.client.protocol.ResponseProcessCookies;
...
import com.pdd.pop.ext.apache.http.conn.ConnectionKeepAliveStrategy;
...
import com.pdd.pop.ext.apache.http.conn.socket.LayeredConnectionSocketFactory;
import com.pdd.pop.ext.apache.http.conn.socket.PlainConnectionSocketFactory;
import com.pdd.pop.ext.apache.http.conn.ssl.DefaultHostnameVerifier;
import com.pdd.pop.ext.apache.http.conn.ssl.SSLConnectionSocketFactory;
import com.pdd.pop.ext.apache.http.conn.ssl.X509HostnameVerifier;
import com.pdd.pop.ext.apache.http.conn.util.PublicSuffixMatcher;
import com.pdd.pop.ext.apache.http.conn.util.PublicSuffixMatcherLoader;
import com.pdd.pop.ext.apache.http.cookie.CookieSpecProvider;
import com.pdd.pop.ext.apache.http.impl.NoConnectionReuseStrategy;
import com.pdd.pop.ext.apache.http.impl.auth.BasicSchemeFactory;
import com.pdd.pop.ext.apache.http.impl.auth.DigestSchemeFactory;
import com.pdd.pop.ext.apache.http.impl.auth.KerberosSchemeFactory;
import com.pdd.pop.ext.apache.http.impl.auth.NTLMSchemeFactory;
import com.pdd.pop.ext.apache.http.impl.auth.SPNegoSchemeFactory;
import com.pdd.pop.ext.apache.http.impl.conn.DefaultProxyRoutePlanner;
import com.pdd.pop.ext.apache.http.impl.conn.DefaultRoutePlanner;
import com.pdd.pop.ext.apache.http.impl.conn.DefaultSchemePortResolver;
import com.pdd.pop.ext.apache.http.impl.conn.PoolingHttpClientConnectionManager;
import com.pdd.pop.ext.apache.http.impl.conn.SystemDefaultRoutePlanner;
import com.pdd.pop.ext.apache.http.impl.execchain.BackoffStrategyExec;
import com.pdd.pop.ext.apache.http.impl.execchain.ClientExecChain;
import com.pdd.pop.ext.apache.http.impl.execchain.MainClientExec;
import com.pdd.pop.ext.apache.http.impl.execchain.ProtocolExec;
import com.pdd.pop.ext.apache.http.impl.execchain.RedirectExec;
import com.pdd.pop.ext.apache.http.impl.execchain.RetryExec;
import com.pdd.pop.ext.apache.http.impl.execchain.ServiceUnavailableRetryExec;
import com.pdd.pop.ext.apache.http.protocol.HttpProcessor;
import com.pdd.pop.ext.apache.http.protocol.HttpProcessorBuilder;
import com.pdd.pop.ext.apache.http.protocol.HttpRequestExecutor;
import com.pdd.pop.ext.apache.http.protocol.ImmutableHttpProcessor;
import com.pdd.pop.ext.apache.http.protocol.RequestContent;
import com.pdd.pop.ext.apache.http.protocol.RequestTargetHost;
import com.pdd.pop.ext.apache.http.protocol.RequestUserAgent;
import com.pdd.pop.ext.apache.http.ssl.SSLContexts;
import com.pdd.pop.ext.apache.http.util.TextUtils;
import com.pdd.pop.ext.apache.http.util.VersionInfo;
...
public class HttpClientBuilder {
     ...
     *   com.pdd.pop.ext.apache.http.conn.HttpClientConnectionManager)} and the {@link #setSSLSocketFactory(
     *   com.pdd.pop.ext.apache.http.conn.socket.LayeredConnectionSocketFactory)} methods.
     * </p>
     *
     *   @deprecated (4.4)
     */
     ...
     * with {@link com.pdd.pop.ext.apache.http.conn.util.PublicSuffixMatcherLoader}.
     *
     * @see com.pdd.pop.ext.apache.http.conn.util.PublicSuffixMatcher
     * @see com.pdd.pop.ext.apache.http.conn.util.PublicSuffixMatcherLoader
     *
     *   @since 4.4
     */
     ...
     * <p>
     * Please note this value can be overridden by the {@link #setConnectionManager(
     *   com.pdd.pop.ext.apache.http.conn.HttpClientConnectionManager)} method.
     * </p>
     */
     ...
     * com.pdd.pop.ext.apache.http.protocol.HttpProcessor)} method.
     * </p>
     */
     ...
     *   com.pdd.pop.ext.apache.http.conn.routing.HttpRoutePlanner)} method.
     */
...
`     */
    ...
    /**
     * Assigns default {@link com.pdd.pop.ext.apache.http.auth.AuthScheme} registry which will
    ...
    /**
     * Assigns default {@link com.pdd.pop.ext.apache.http.cookie.CookieSpec} registry which will
     * be used for request execution if not explicitly set in the client execution
     * context.
     *
     * @see com.pdd.pop.ext.apache.http.impl.client.CookieSpecRegistries
     *
     */
    ...
    /**
     * Assigns a map of {@link com.pdd.pop.ext.apache.http.client.entity.InputStreamFactory}s
     ...
     * @see com.pdd.pop.ext.apache.http.conn.HttpClientConnectionManager#closeExpiredConnections()
     *
     * @since 4.4
     */
        ...
        if (userAgentCopy == null) {
            ...
            if (userAgentCopy == null && !defaultUserAgentDisabled) {
                userAgentCopy = VersionInfo.getUserAgent("Apache-HttpClient",
                        "com.pdd.pop.ext.apache.http.client", getClass());
            }
        }
