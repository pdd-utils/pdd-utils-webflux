...
import com.pdd.pop.ext.apache.http.cookie.params.CookieSpecPNames;
import com.pdd.pop.ext.apache.http.params.HttpParams;
import com.pdd.pop.ext.apache.http.protocol.HttpContext;

/**
 * {@link com.pdd.pop.ext.apache.http.cookie.CookieSpecProvider} implementation that provides an instance of
 * {@link com.pdd.pop.ext.apache.http.impl.cookie.BestMatchSpec}. The instance returned by this factory can
 * be shared by multiple threads.
 *
 * @deprecated (4.4) use {@link com.pdd.pop.ext.apache.http.impl.cookie.DefaultCookieSpecProvider}.
 *
 * @since 4.0
 */
