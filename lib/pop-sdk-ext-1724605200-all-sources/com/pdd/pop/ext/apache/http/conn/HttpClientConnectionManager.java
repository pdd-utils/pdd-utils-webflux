...
public interface HttpClientConnectionManager {
     ...
     * by calling {@link #connect(com.pdd.pop.ext.apache.http.HttpClientConnection,
     *   com.pdd.pop.ext.apache.http.conn.routing.HttpRoute, int,
     *   com.pdd.pop.ext.apache.http.protocol.HttpContext) connect} in order to connect
     * directly to the target or to the first proxy hop, optionally calling
     * {@link #upgrade(com.pdd.pop.ext.apache.http.HttpClientConnection,
     *   com.pdd.pop.ext.apache.http.conn.routing.HttpRoute,
     *   com.pdd.pop.ext.apache.http.protocol.HttpContext) upgrade} method to upgrade
     ...
     *  com.pdd.pop.ext.apache.http.HttpClientConnection,
     *  com.pdd.pop.ext.apache.http.conn.routing.HttpRoute,
     *  com.pdd.pop.ext.apache.http.protocol.HttpContext) routeComplete} to mark the route
     *  as fully completed.
     * </p>
     *
