...
import com.pdd.pop.ext.fasterxml.jackson.databind.jsonFormatVisitors.JsonStringFormatVisitor;
...
import com.pdd.pop.ext.fasterxml.jackson.databind.ser.BeanSerializer;
import com.pdd.pop.ext.fasterxml.jackson.databind.ser.ContextualSerializer;
import com.pdd.pop.ext.fasterxml.jackson.databind.util.ClassUtil;

/**
 * Serializer class that can serialize Object that have a
 * {@link com.pdd.pop.ext.fasterxml.jackson.annotation.JsonValue} annotation to
    ...
    implements ContextualSerializer, JsonFormatVisitable, SchemaAware
{
     ...
     *    {@link com.pdd.pop.ext.fasterxml.jackson.databind.annotation.JsonSerialize#using}), otherwise
     *    null
     *    
        ...
        throws JsonMappingException
    {
        ...
        return com.pdd.pop.ext.fasterxml.jackson.databind.jsonschema.JsonSchema.getDefaultSchemaNode();
    }
