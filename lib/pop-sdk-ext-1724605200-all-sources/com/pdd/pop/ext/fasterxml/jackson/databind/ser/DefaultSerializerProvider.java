...
filter.getClass().getName(), t.getClass().getName(), ClassUtil.exceptionMessage(t));
    ...
    public com.pdd.pop.ext.fasterxml.jackson.databind.jsonschema.JsonSchema generateJsonSchema(Class<?> type)
        throws JsonMappingException
    {
        /* no need for embedded type information for JSON schema generation (all
         * type information it needs is accessible via "untyped" serializer)
        ...
        JsonNode schemaNode = (ser instanceof SchemaAware) ?
                ((SchemaAware) ser).getSchema(this, null) : com.pdd.pop.ext.fasterxml.jackson.databind.jsonschema.JsonSchema.getDefaultSchemaNode();
        if (!(schemaNode instanceof ObjectNode)) {
            throw new IllegalArgumentException("Class " + type.getName()
                    +" would not be serialized as a JSON object and therefore has no schema");
        }
        return new com.pdd.pop.ext.fasterxml.jackson.databind.jsonschema.JsonSchema((ObjectNode) schemaNode);
    }
