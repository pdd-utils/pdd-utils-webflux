...
import com.pdd.pop.ext.fasterxml.jackson.annotation.JsonTypeInfo;
import com.pdd.pop.ext.fasterxml.jackson.annotation.PropertyAccessor;
import com.pdd.pop.ext.fasterxml.jackson.core.*;
import com.pdd.pop.ext.fasterxml.jackson.databind.*;
import com.pdd.pop.ext.fasterxml.jackson.databind.ObjectMapper.DefaultTyping;
import com.pdd.pop.ext.fasterxml.jackson.databind.deser.*;
import com.pdd.pop.ext.fasterxml.jackson.databind.introspect.VisibilityChecker;
import com.pdd.pop.ext.fasterxml.jackson.databind.jsontype.NamedType;
import com.pdd.pop.ext.fasterxml.jackson.databind.jsontype.PolymorphicTypeValidator;
import com.pdd.pop.ext.fasterxml.jackson.databind.jsontype.SubtypeResolver;
import com.pdd.pop.ext.fasterxml.jackson.databind.jsontype.TypeResolverBuilder;
    ...
    B extends MapperBuilder<M,B>>
{
    ...
    public B addModule(com.pdd.pop.ext.fasterxml.jackson.databind.Module module)
    {
        _mapper.registerModule(module);
        return _this();
    }

    public B addModules(com.pdd.pop.ext.fasterxml.jackson.databind.Module... modules)
    {
        for (com.pdd.pop.ext.fasterxml.jackson.databind.Module module : modules) {
            addModule(module);
        }
        return _this();
    }

    public B addModules(Iterable<? extends com.pdd.pop.ext.fasterxml.jackson.databind.Module> modules)
    {
        for (com.pdd.pop.ext.fasterxml.jackson.databind.Module module : modules) {
            addModule(module);
        }
     ...
     */
    public static List<com.pdd.pop.ext.fasterxml.jackson.databind.Module> findModules() {
     ...
     * potentially expensive.
     */
    public static List<com.pdd.pop.ext.fasterxml.jackson.databind.Module> findModules(ClassLoader classLoader)
    {
        ArrayList<com.pdd.pop.ext.fasterxml.jackson.databind.Module> modules = new ArrayList<>();
        ServiceLoader<com.pdd.pop.ext.fasterxml.jackson.databind.Module> loader = secureGetServiceLoader(com.pdd.pop.ext.fasterxml.jackson.databind.Module.class, classLoader);
        for (com.pdd.pop.ext.fasterxml.jackson.databind.Module module : loader) {
            modules.add(module);
        }
        return modules;
    }
     ...
     * have a look at {@link com.pdd.pop.ext.fasterxml.jackson.databind.introspect.AnnotationIntrospectorPair}.
     *
     * @see com.pdd.pop.ext.fasterxml.jackson.databind.introspect.AnnotationIntrospectorPair
     */
     ...
     * have been annotated with {@link com.pdd.pop.ext.fasterxml.jackson.annotation.JsonTypeInfo}).
     *<P>
     ...
     * {@link com.pdd.pop.ext.fasterxml.jackson.annotation.JsonTypeInfo}) will have
     ...
     * {@link com.pdd.pop.ext.fasterxml.jackson.databind.jsontype.impl.StdTypeResolverBuilder}
