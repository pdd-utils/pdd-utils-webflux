...
import com.pdd.pop.ext.fasterxml.jackson.core.format.InputAccessor;
import com.pdd.pop.ext.fasterxml.jackson.core.format.MatchStrength;
import com.pdd.pop.ext.fasterxml.jackson.core.io.*;
import com.pdd.pop.ext.fasterxml.jackson.core.json.*;
import com.pdd.pop.ext.fasterxml.jackson.core.json.async.NonBlockingJsonParser;
import com.pdd.pop.ext.fasterxml.jackson.core.sym.ByteQuadsCanonicalizer;
import com.pdd.pop.ext.fasterxml.jackson.core.sym.CharsToNameCanonicalizer;
import com.pdd.pop.ext.fasterxml.jackson.core.util.BufferRecycler;
import com.pdd.pop.ext.fasterxml.jackson.core.util.BufferRecyclers;
import com.pdd.pop.ext.fasterxml.jackson.core.util.DefaultPrettyPrinter;
        ...
        java.io.Serializable // since 2.1 (for Android, mostly)
{
     ...
     * {@link com.pdd.pop.ext.fasterxml.jackson.core.async.NonBlockingInputFeeder}.
     *
     * @since 2.9
     */
    @Override
     ...
     * a <code>com.pdd.pop.ext.fasterxml.jackson.databind.ObjectMapper</code>)
     ...
     * if (and only if) {@link com.pdd.pop.ext.fasterxml.jackson.core.StreamReadFeature#AUTO_CLOSE_SOURCE}
     * is enabled.
     *<p>
     *
     ...
     * via {@link com.pdd.pop.ext.fasterxml.jackson.core.async.ByteArrayFeeder}
     ...
     * feature,
     * {@link com.pdd.pop.ext.fasterxml.jackson.core.JsonGenerator.Feature#AUTO_CLOSE_TARGET}
     * is enabled).
     ...
     * {@link JsonGenerator#close} is called (unless auto-closing
     * feature,
     * {@link com.pdd.pop.ext.fasterxml.jackson.core.JsonGenerator.Feature#AUTO_CLOSE_TARGET} is enabled).
     ...
     * the parser, it will still be managed (i.e. closed if
     * end-of-stream is reacher, or parser close method called)
     * if (and only if) {@link com.pdd.pop.ext.fasterxml.jackson.core.JsonParser.Feature#AUTO_CLOSE_SOURCE}
     * is enabled.
     *<p>
     *
     * Note: no encoding argument is taken since it can always be
