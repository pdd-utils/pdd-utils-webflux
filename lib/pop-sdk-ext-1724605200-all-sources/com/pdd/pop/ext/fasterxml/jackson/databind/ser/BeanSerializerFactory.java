...
import com.pdd.pop.ext.fasterxml.jackson.annotation.ObjectIdGenerators;
import com.pdd.pop.ext.fasterxml.jackson.annotation.JsonTypeInfo.As;

import com.pdd.pop.ext.fasterxml.jackson.databind.*;
import com.pdd.pop.ext.fasterxml.jackson.databind.cfg.SerializerFactoryConfig;
...
import com.pdd.pop.ext.fasterxml.jackson.databind.ser.impl.FilteredBeanPropertyWriter;
...
import com.pdd.pop.ext.fasterxml.jackson.databind.ser.std.MapSerializer;
import com.pdd.pop.ext.fasterxml.jackson.databind.ser.std.StdDelegatingSerializer;
import com.pdd.pop.ext.fasterxml.jackson.databind.type.ReferenceType;
...
//            throw new IllegalArgumentException("Cannot create bean serializer for Object.class");
     ...
     * by default this is based on {@link com.pdd.pop.ext.fasterxml.jackson.annotation.JsonIgnoreType}
