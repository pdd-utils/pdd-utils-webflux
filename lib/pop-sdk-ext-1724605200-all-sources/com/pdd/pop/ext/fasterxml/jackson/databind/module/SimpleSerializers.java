...
import com.pdd.pop.ext.fasterxml.jackson.databind.type.ArrayType;
import com.pdd.pop.ext.fasterxml.jackson.databind.type.ClassKey;
import com.pdd.pop.ext.fasterxml.jackson.databind.type.CollectionLikeType;
import com.pdd.pop.ext.fasterxml.jackson.databind.type.CollectionType;
import com.pdd.pop.ext.fasterxml.jackson.databind.type.MapLikeType;
import com.pdd.pop.ext.fasterxml.jackson.databind.type.MapType;
    ...
    public void addSerializer(JsonSerializer<?> ser)
    {
        ...
        if (cls == null || cls == Object.class) {
            throw new IllegalArgumentException("JsonSerializer of type "+ser.getClass().getName()
                    ...
                    +" or make serializer extend 'com.pdd.pop.ext.fasterxml.jackson.databind.ser.std.StdSerializer'"); 
        }
