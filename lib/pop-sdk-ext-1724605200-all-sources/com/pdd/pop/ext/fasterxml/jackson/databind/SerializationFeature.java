...
public enum SerializationFeature implements ConfigFeature
{
     ...
     * no explicit {@link com.pdd.pop.ext.fasterxml.jackson.core.PrettyPrinter} has been configured
     ...
     * in conjunction with {@link com.pdd.pop.ext.fasterxml.jackson.annotation.JsonUnwrapped}.
     ...
     * the default formatting is provided by {@link com.pdd.pop.ext.fasterxml.jackson.databind.util.StdDateFormat},
     ...
     *   using {@link com.pdd.pop.ext.fasterxml.jackson.annotation.JsonInclude} or configuration overrides
     ...
     * {@link com.pdd.pop.ext.fasterxml.jackson.core.JsonGenerator#writeNumber(String)}
     * it may cause compatibility problems since not all {@link com.pdd.pop.ext.fasterxml.jackson.core.JsonGenerator}
     * implementations support such mode of output: usually only text-based formats
     * support it.
     *<p>
     * Feature is disabled by default.
     * 
     * @deprecated Since 2.5: use {@link com.pdd.pop.ext.fasterxml.jackson.core.JsonGenerator.Feature#WRITE_BIGDECIMAL_AS_PLAIN} instead
     *    (using {@link ObjectWriter#with(com.pdd.pop.ext.fasterxml.jackson.core.JsonGenerator.Feature)}).
     */
