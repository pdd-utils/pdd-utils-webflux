...
public enum DeserializationFeature implements ConfigFeature
{
     ...
     * {@link com.pdd.pop.ext.fasterxml.jackson.databind.node.JsonNodeFactory} has
     * {@link com.pdd.pop.ext.fasterxml.jackson.databind.node.JsonNodeFactory#withExactBigDecimals} for
     ...
     * will throw a {@link com.pdd.pop.ext.fasterxml.jackson.core.JsonProcessingException}.
     *<p>
     ...
     * value (indicated for example by {@link com.pdd.pop.ext.fasterxml.jackson.annotation.JsonTypeInfo})
     ...
     * ({@link com.pdd.pop.ext.fasterxml.jackson.core.TreeNode}) and a duplicate key
     ...
     * {@link com.pdd.pop.ext.fasterxml.jackson.annotation.JsonTypeInfo.As#EXTERNAL_PROPERTY} is missing,
     ...
     * {@link com.pdd.pop.ext.fasterxml.jackson.core.JsonParser#nextToken} is made to ensure that
     * no more tokens are found (and if any is found,
     * {@link com.pdd.pop.ext.fasterxml.jackson.databind.exc.MismatchedInputException} is thrown); if
     ...
     * {@link com.pdd.pop.ext.fasterxml.jackson.annotation.JsonEnumDefaultValue @JsonEnumDefaultValue} annotation.
     * If disabled, unknown Enum values will throw exceptions.
