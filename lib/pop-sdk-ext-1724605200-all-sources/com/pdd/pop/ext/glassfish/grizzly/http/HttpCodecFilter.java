...
import com.pdd.pop.ext.glassfish.grizzly.http.util.CacheableDataChunk;
...
import com.pdd.pop.ext.glassfish.grizzly.memory.CompositeBuffer.DisposeOrder;
...
import static com.pdd.pop.ext.glassfish.grizzly.http.util.HttpCodecUtils.*;
import static com.pdd.pop.ext.glassfish.grizzly.utils.Charsets.ASCII_CHARSET;

/**
 * The {@link com.pdd.pop.ext.glassfish.grizzly.filterchain.Filter}, responsible for transforming {@link Buffer} into
 * {@link HttpPacket} and vice versa in asynchronous mode.
 * When the <tt>HttpCodecFilter</tt> is added to a {@link com.pdd.pop.ext.glassfish.grizzly.filterchain.FilterChain}, on read phase
...
public abstract class HttpCodecFilter extends HttpBaseFilter
    ...
    protected boolean preserveHeaderCase =
            Boolean.parseBoolean(System.getProperty("com.pdd.pop.ext.glassfish.grizzly.http.PRESERVE_HEADER_CASE", "false"));
     ...
     * {@link com.pdd.pop.ext.glassfish.grizzly.filterchain.Filter}.
     * </p>
     *
...
//        buffer = httpHeader.serializeContentType(memoryManager, buffer);
    ...
    protected Object createJmxManagementObject() {
        return MonitoringUtils.loadJmxObject(
                "com.pdd.pop.ext.glassfish.grizzly.http.jmx.HttpCodecFilter", this,
