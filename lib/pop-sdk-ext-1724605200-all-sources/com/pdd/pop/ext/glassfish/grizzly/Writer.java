 ...
 * {@link com.pdd.pop.ext.glassfish.grizzly.asyncqueue.AsyncQueueWriter},
 * {@link com.pdd.pop.ext.glassfish.grizzly.nio.tmpselectors.TemporarySelectorWriter}.
 *
...
public interface Writer<L> {
     ...
     * @param completionHandler {@link com.pdd.pop.ext.glassfish.grizzly.CompletionHandler},
     *        which will get notified, when write will be completed
     * @param pushBackHandler {@link com.pdd.pop.ext.glassfish.grizzly.asyncqueue.PushBackHandler}, which will be notified
    ...
    final class Reentrant {
        ...
        private static final int maxWriteReentrants = Integer.getInteger(
                "com.pdd.pop.ext.glassfish.grizzly.Writer.max-write-reentrants", 10);
         ...
         * developer wants to use custom notification mechanism, based on on {@link #canWrite(com.pdd.pop.ext.glassfish.grizzly.Connection)}
