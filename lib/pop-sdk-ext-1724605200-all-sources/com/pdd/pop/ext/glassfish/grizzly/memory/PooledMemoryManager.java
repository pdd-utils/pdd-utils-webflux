 ...
 * </ul>
 *
 * The main advantage of this manager over {@link com.pdd.pop.ext.glassfish.grizzly.memory.HeapMemoryManager} or
 * {@link com.pdd.pop.ext.glassfish.grizzly.memory.ByteBufferManager} is that this implementation doesn't use ThreadLocal pools
...
public class PooledMemoryManager implements MemoryManager<Buffer>, WrapperAware {
    ...
    protected Object createJmxManagementObject() {
        ...
        return MonitoringUtils.loadJmxObject(
                "com.pdd.pop.ext.glassfish.grizzly.memory.jmx.PooledMemoryManager", this,
    ...
    private static final class PoolHeapBuffer extends HeapBuffer
         ...
         * @param owner the {@link com.pdd.pop.ext.glassfish.grizzly.memory.PooledMemoryManager.PoolSlice} that owns
