...
public final class ThreadCache {
     ...
     * Unlike {@link #takeFromCache(com.pdd.pop.ext.glassfish.grizzly.ThreadCache.CachedTypeIndex)}, the
     ...
     * Unlike {@link #getFromCache(com.pdd.pop.ext.glassfish.grizzly.ThreadCache.CachedTypeIndex)}, the
    ...
    public static final class ObjectCache {
        ...
        /**
         * Get the cached object with the given type index from cache.
         * Unlike {@link #take(com.pdd.pop.ext.glassfish.grizzly.ThreadCache.CachedTypeIndex)}, the
         * object won't be removed from cache.
         * 
         * @param <E>
         * @param index the cached object type index.
        ...
        /**
         * Take the cached object with the given type index from cache.
         * Unlike {@link #get(com.pdd.pop.ext.glassfish.grizzly.ThreadCache.CachedTypeIndex)}, the
         * object will be removed from cache.
         *
         * @param <E>
         * @param index the cached object type index.
