...
public interface Transport extends MonitoringAware<TransportProbe> {
     ...
     * tasks. For example {@link com.pdd.pop.ext.glassfish.grizzly.nio.SelectorRunner}
     *  threads for NIO.
     */
     ...
     * {@link com.pdd.pop.ext.glassfish.grizzly.nio.SelectorRunner} threads for NIO.
     *
     * @param threadPool {@link ExecutorService} for {@link com.pdd.pop.ext.glassfish.grizzly.nio.SelectorRunner}s
     */
     ...
     *  {@link com.pdd.pop.ext.glassfish.grizzly.Transport}'s internal tasks.
     *  For example
     *  {@link com.pdd.pop.ext.glassfish.grizzly.nio.SelectorRunner}s for NIO.
     */
