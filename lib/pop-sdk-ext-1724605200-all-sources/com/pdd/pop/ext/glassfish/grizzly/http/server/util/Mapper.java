...
import com.pdd.pop.ext.glassfish.grizzly.http.server.naming.DirContext;
import com.pdd.pop.ext.glassfish.grizzly.http.server.naming.NamingContext;
import com.pdd.pop.ext.glassfish.grizzly.http.server.naming.NamingException;
...
import com.pdd.pop.ext.glassfish.grizzly.http.util.MessageBytes;
...
public class Mapper {
    ...
    private static final String DEFAULT_SERVLET =
            System.getProperty("com.pdd.pop.ext.glassfish.grizzly.servlet.defaultServlet", "default");

    private static final String JSP_SERVLET =
            System.getProperty("com.pdd.pop.ext.glassfish.grizzly.servlet.jspServlet", "jsp");
