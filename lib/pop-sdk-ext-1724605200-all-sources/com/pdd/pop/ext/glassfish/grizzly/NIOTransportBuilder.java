...
import com.pdd.pop.ext.glassfish.grizzly.nio.NIOChannelDistributor;
import com.pdd.pop.ext.glassfish.grizzly.nio.NIOTransport;
import com.pdd.pop.ext.glassfish.grizzly.nio.SelectionKeyHandler;
import com.pdd.pop.ext.glassfish.grizzly.nio.SelectorHandler;
...
public abstract class NIOTransportBuilder<T extends NIOTransportBuilder> {
     ...
     *  {@link com.pdd.pop.ext.glassfish.grizzly.nio.SelectorRunner}s.
     */
    ...
    /**
     * @see com.pdd.pop.ext.glassfish.grizzly.nio.transport.TCPNIOTransport#isReuseAddress()
     */
     ...
     * @see com.pdd.pop.ext.glassfish.grizzly.nio.transport.TCPNIOTransport#setReuseAddress(boolean)
     */
    ...
    /**
     * @see com.pdd.pop.ext.glassfish.grizzly.asyncqueue.AsyncQueueWriter#getMaxPendingBytesPerConnection()
     * <p/>
    ...
    /**
     * @return this <code>TCPNIOTransportBuilder</code>
     * @see com.pdd.pop.ext.glassfish.grizzly.asyncqueue.AsyncQueueWriter#setMaxPendingBytesPerConnection(int)
     * <p/>
     * Note: the value is per connection, not transport total.
     */
    ...
    /**
     * @see com.pdd.pop.ext.glassfish.grizzly.nio.NIOTransport#isOptimizedForMultiplexing()
     */
    ...
    /**
     * @see com.pdd.pop.ext.glassfish.grizzly.nio.NIOTransport#setOptimizedForMultiplexing(boolean)
     *
     * @return this <code>TCPNIOTransportBuilder</code>
     */
