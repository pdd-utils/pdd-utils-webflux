...
import com.pdd.pop.ext.glassfish.grizzly.Appendable;
...
import com.pdd.pop.ext.glassfish.grizzly.ProcessorExecutor;
...
public class FilterChainContext implements AttributeStorage {
     ...
     * current {@link com.pdd.pop.ext.glassfish.grizzly.IOEvent} processing.
     */
     ...
     * current {@link com.pdd.pop.ext.glassfish.grizzly.IOEvent} processing.
     * 
     * When we process {@link com.pdd.pop.ext.glassfish.grizzly.IOEvent#READ} event - it represents sender address,
     * or when process {@link com.pdd.pop.ext.glassfish.grizzly.IOEvent#WRITE} - address of receiver.
     * 
    ...
    /**
     * Set address, associated with the current {@link com.pdd.pop.ext.glassfish.grizzly.IOEvent} processing.
     * When we process {@link com.pdd.pop.ext.glassfish.grizzly.IOEvent#READ} event - it represents sender address,
     * or when process {@link com.pdd.pop.ext.glassfish.grizzly.IOEvent#WRITE} - address of receiver.
     *
     * @param addressHolder {@link Holder}, which contains address, associated with the current {@link com.pdd.pop.ext.glassfish.grizzly.IOEvent} processing.
     */
    ...
    /**
     * Get address, associated with the current {@link com.pdd.pop.ext.glassfish.grizzly.IOEvent} processing.
     * When we process {@link com.pdd.pop.ext.glassfish.grizzly.IOEvent#READ} event - it represents sender address,
     * or when process {@link com.pdd.pop.ext.glassfish.grizzly.IOEvent#WRITE} - address of receiver.
     * 
     * @return address, associated with the current {@link com.pdd.pop.ext.glassfish.grizzly.IOEvent} processing.
     */
     ...
     * or when process {@link com.pdd.pop.ext.glassfish.grizzly.IOEvent#WRITE} - address of receiver.
     *
     * @param address address, associated with the current {@link com.pdd.pop.ext.glassfish.grizzly.IOEvent} processing.
     */
     ...
     * 
     * @param appender the {@link com.pdd.pop.ext.glassfish.grizzly.Appender}, which knows
    ...
    public <E> NextAction getInvokeAction(final E incompleteChunk,
            com.pdd.pop.ext.glassfish.grizzly.Appender<E> appender) {
    ...
    public <E> NextAction getStopAction(final E incompleteChunk,
            final com.pdd.pop.ext.glassfish.grizzly.Appender<E> appender) {
    ...
    public static final class TransportContext {
        ...
        @Deprecated
        public com.pdd.pop.ext.glassfish.grizzly.asyncqueue.PushBackHandler getPushBackHandler() {
            return pushBackHandler;
        }

        @Deprecated
        public void setPushBackHandler(com.pdd.pop.ext.glassfish.grizzly.asyncqueue.PushBackHandler pushBackHandler) {
     ...
     *
     * @see #addCompletionListener(com.pdd.pop.ext.glassfish.grizzly.filterchain.FilterChainContext.CompletionListener)
     */
     ...
     *
     * @see #addCopyListener(com.pdd.pop.ext.glassfish.grizzly.filterchain.FilterChainContext.CopyListener)
     */
