...
import com.pdd.pop.ext.glassfish.grizzly.CloseListener;
...
import com.pdd.pop.ext.glassfish.grizzly.http.HttpContext;
...
import com.pdd.pop.ext.glassfish.grizzly.http.io.NIOOutputStream;
import com.pdd.pop.ext.glassfish.grizzly.http.io.NIOWriter;
import com.pdd.pop.ext.glassfish.grizzly.http.io.OutputBuffer;
import com.pdd.pop.ext.glassfish.grizzly.http.server.io.ServerOutputBuffer;
import com.pdd.pop.ext.glassfish.grizzly.http.server.util.Globals;
import com.pdd.pop.ext.glassfish.grizzly.http.server.util.HtmlHelper;
import com.pdd.pop.ext.glassfish.grizzly.http.util.CharChunk;

import static com.pdd.pop.ext.glassfish.grizzly.http.util.Constants.*;
import com.pdd.pop.ext.glassfish.grizzly.http.util.ContentType;
import com.pdd.pop.ext.glassfish.grizzly.http.util.CookieSerializerUtils;
import com.pdd.pop.ext.glassfish.grizzly.http.util.FastHttpDateFormat;
import com.pdd.pop.ext.glassfish.grizzly.http.util.Header;
import com.pdd.pop.ext.glassfish.grizzly.http.util.HeaderValue;
import com.pdd.pop.ext.glassfish.grizzly.http.util.HttpRequestURIDecoder;
...
import com.pdd.pop.ext.glassfish.grizzly.http.util.UEncoder;
...
import com.pdd.pop.ext.glassfish.grizzly.utils.DelayedExecutor.DelayQueue;
...
public class Response {
    ...
    protected static final String info =
        "com.pdd.pop.ext.glassfish.grizzly.http.server.Response/2.0";
    ...
    /**
     * Grizzly {@link com.pdd.pop.ext.glassfish.grizzly.filterchain.FilterChain} context,
     ...
     * {@link NIOOutputStream#notifyCanWrite(com.pdd.pop.ext.glassfish.grizzly.WriteHandler)} to
     * avoid blocking.
     *
     * @return the {@link NIOOutputStream} associated with this {@link Response}.
     *
     ...
     * {@link NIOWriter#notifyCanWrite(com.pdd.pop.ext.glassfish.grizzly.WriteHandler)} to
     * avoid blocking.
     *
     ...
     *
     * If the <code>length</code> argument is negative - then {@link com.pdd.pop.ext.glassfish.grizzly.http.HttpPacket}
            ...
            try {
                ...
                try {
                   getOutputStream().write(sb.toString().getBytes(
                           com.pdd.pop.ext.glassfish.grizzly.http.util.Constants.DEFAULT_HTTP_CHARSET));
     ...
     * make sure {@link com.pdd.pop.ext.glassfish.grizzly.CompletionHandler#cancelled()}
     * is invoked with the original <tt>attachment</tt>. If the timeout expires, the
     * {@link com.pdd.pop.ext.glassfish.grizzly.CompletionHandler#cancelled()} is invoked with the original <tt>attachment</tt> and
     ...
     * @param timeunit timeout units
     * @param completionHandler a {@link com.pdd.pop.ext.glassfish.grizzly.CompletionHandler}
     */
    public void suspend(final long timeout, final TimeUnit timeunit,
    ...
    final void checkResponse() {
        if (response == null) {
            throw new IllegalStateException("Internal " +
                    "com.pdd.pop.ext.glassfish.grizzly.http.server.Response has not been set");
        }
    }
