...
public interface Connection<L> extends Readable<L>, Writeable<L>,
     ...
     * 
     * @deprecated use {@link #close()} with the following {@link GrizzlyFuture#addCompletionHandler(com.pdd.pop.ext.glassfish.grizzly.CompletionHandler)}.
     */
    @Override
     ...
     */
    @Override
    void addCloseListener(com.pdd.pop.ext.glassfish.grizzly.CloseListener closeListener);
     ...
     */
    @Override
    boolean removeCloseListener(com.pdd.pop.ext.glassfish.grizzly.CloseListener closeListener);
     ...
     * @param closeListener {@link CloseListener}
     *
     * @deprecated use {@link #addCloseListener(com.pdd.pop.ext.glassfish.grizzly.CloseListener)}
     */
    @Deprecated
     ...
     * @param closeListener {@link CloseListener}.
     *
     * @deprecated use {@link #removeCloseListener(com.pdd.pop.ext.glassfish.grizzly.CloseListener)}
     */
    @Deprecated
     ...
     *
     * @deprecated use {@link com.pdd.pop.ext.glassfish.grizzly.CloseListener}
     *
     * @see GenericCloseListener
     */
    @Deprecated
    interface CloseListener extends com.pdd.pop.ext.glassfish.grizzly.CloseListener<Connection, CloseType> {
     ...
     *
     * @deprecated use {@link com.pdd.pop.ext.glassfish.grizzly.CloseType}
     */
    @Deprecated
