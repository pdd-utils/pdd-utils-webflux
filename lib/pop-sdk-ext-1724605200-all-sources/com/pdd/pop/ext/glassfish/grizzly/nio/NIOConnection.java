...
public abstract class NIOConnection implements Connection<SocketAddress> {
    ...
    private final Queue<com.pdd.pop.ext.glassfish.grizzly.CloseListener> closeListeners =
            new ConcurrentLinkedQueue<com.pdd.pop.ext.glassfish.grizzly.CloseListener>();
