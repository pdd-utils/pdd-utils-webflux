...
import com.pdd.pop.ext.glassfish.grizzly.http.Note;
...
import com.pdd.pop.ext.glassfish.grizzly.http.io.NIOReader;
import com.pdd.pop.ext.glassfish.grizzly.http.server.io.ServerInputBuffer;
...
import com.pdd.pop.ext.glassfish.grizzly.http.server.util.ParameterMap;
import com.pdd.pop.ext.glassfish.grizzly.http.server.util.RequestUtils;
import com.pdd.pop.ext.glassfish.grizzly.http.server.util.SimpleDateFormats;
import com.pdd.pop.ext.glassfish.grizzly.http.server.util.StringParser;
import com.pdd.pop.ext.glassfish.grizzly.http.util.Chunk;
...
import com.pdd.pop.ext.glassfish.grizzly.http.util.Parameters;
...
import static com.pdd.pop.ext.glassfish.grizzly.http.util.Constants.FORM_POST_CONTENT_TYPE;
/**
...
public class Request {
     ...
     * user's code in {@link HttpHandler#service(com.pdd.pop.ext.glassfish.grizzly.http.server.Request, com.pdd.pop.ext.glassfish.grizzly.http.server.Response)}
     * and notifying {@link ReadHandler}, {@link WriteHandler} registered by the user.
     * 
    ...
    private Charset lookupCharset(final String enc) {
        ...
        if (enc != null) {
            try {
                ...
                charset = com.pdd.pop.ext.glassfish.grizzly.http.util.Constants.DEFAULT_HTTP_CHARSET;
            }
        } else {
            charset = com.pdd.pop.ext.glassfish.grizzly.http.util.Constants.DEFAULT_HTTP_CHARSET;
        }
