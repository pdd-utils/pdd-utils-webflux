...
import com.pdd.pop.ext.glassfish.grizzly.http.HttpPacket;
...
public class HttpServerFilter extends BaseFilter
    ...
    protected Object createJmxManagementObject() {
        return MonitoringUtils.loadJmxObject(
                "com.pdd.pop.ext.glassfish.grizzly.http.server.jmx.HttpServerFilter",
    ...
    private NextAction afterService(
        ...
        if (isBroken) {
            ...
            // {@link com.pdd.pop.ext.glassfish.grizzly.http.HttpServerFilter#handleEvent(...)}
