...
import com.pdd.pop.ext.glassfish.grizzly.http.util.MimeType;
...
import com.pdd.pop.ext.glassfish.grizzly.threadpool.Threads;
...
import static com.pdd.pop.ext.glassfish.grizzly.Writer.Reentrant;
...
//        charBuf.position(0);
    ...
    /**
     * @see AsyncQueueWriter#canWrite(com.pdd.pop.ext.glassfish.grizzly.Connection, int)
    ...
    /**
     * @see AsyncQueueWriter#canWrite(com.pdd.pop.ext.glassfish.grizzly.Connection)
     */
    ...
    /**
     * @see AsyncQueueWriter#notifyWritePossible(com.pdd.pop.ext.glassfish.grizzly.Connection, com.pdd.pop.ext.glassfish.grizzly.WriteHandler, int)
     * @deprecated the <code>length</code> parameter will be ignored. Please use {@link #notifyCanWrite(com.pdd.pop.ext.glassfish.grizzly.WriteHandler)}.
     */
    @SuppressWarnings("UnusedParameters")
    ...
    private CharsetEncoder getEncoder() {
        ...
        if (encoder == null) {
            ...
            if (encoding == null) {
                encoding = com.pdd.pop.ext.glassfish.grizzly.http.util.Constants.DEFAULT_HTTP_CHARACTER_ENCODING;
            }
