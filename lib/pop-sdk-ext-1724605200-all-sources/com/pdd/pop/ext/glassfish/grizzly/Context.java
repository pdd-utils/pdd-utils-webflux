...
public class Context implements AttributeStorage, Cacheable {
   ...
   public Context() {
     ...
     * {@link Connection#enableIOEvent(com.pdd.pop.ext.glassfish.grizzly.IOEvent)} or
     * {@link Connection#disableIOEvent(com.pdd.pop.ext.glassfish.grizzly.IOEvent)} might be
     * explicitly called.
     */
    ...
    /**
     * If implementation uses {@link com.pdd.pop.ext.glassfish.grizzly.utils.ObjectPool}
