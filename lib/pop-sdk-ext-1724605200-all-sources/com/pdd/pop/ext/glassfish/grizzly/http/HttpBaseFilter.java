...
public class HttpBaseFilter extends BaseFilter {
     ...
     * @param response
     * 
     * @see {@link HttpRequestPacket#setResponse(com.pdd.pop.ext.glassfish.grizzly.http.HttpResponsePacket)}
     * @see {@link HttpResponsePacket#setRequest(com.pdd.pop.ext.glassfish.grizzly.http.HttpRequestPacket)}
     */
