...
/**
 * Adds the ability for binary based {@link com.pdd.pop.ext.glassfish.grizzly.InputSource}s to obtain the
 * incoming {@link com.pdd.pop.ext.glassfish.grizzly.Buffer} directly without having to
...
public interface BinaryNIOInputSource extends InputSource {
     ...
     * {@link com.pdd.pop.ext.glassfish.grizzly.Buffer} that backs this
    ...
    /**
     * <p>
     * Returns the underlying {@link com.pdd.pop.ext.glassfish.grizzly.Buffer} that backs this
     ...
     * </p>
     *
     * @return the underlying {@link com.pdd.pop.ext.glassfish.grizzly.Buffer} that backs this
     *  <code>InputSource</code>.
     */
    Buffer readBuffer();
    ...
    /**
     * <p>
     * Returns the {@link com.pdd.pop.ext.glassfish.grizzly.Buffer} of a given size,
