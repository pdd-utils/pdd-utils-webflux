...
import com.pdd.pop.ext.glassfish.tyrus.client.ClientProperties;
import com.pdd.pop.ext.glassfish.tyrus.client.SslEngineConfigurator;
import com.pdd.pop.ext.glassfish.tyrus.core.Base64Utils;
...
import com.pdd.pop.ext.glassfish.grizzly.filterchain.FilterChainEvent;
import com.pdd.pop.ext.glassfish.grizzly.filterchain.NextAction;
import com.pdd.pop.ext.glassfish.grizzly.filterchain.TransportFilter;
import com.pdd.pop.ext.glassfish.grizzly.nio.transport.TCPNIOConnectorHandler;
import com.pdd.pop.ext.glassfish.grizzly.nio.transport.TCPNIOTransport;
import com.pdd.pop.ext.glassfish.grizzly.nio.transport.TCPNIOTransportBuilder;
...
import com.pdd.pop.ext.glassfish.grizzly.ssl.SSLFilter;
...
public class GrizzlyClientSocket {
     ...
     *
     * @deprecated please use {@link com.pdd.pop.ext.glassfish.tyrus.container.grizzly.client
    ...
    private ThreadPoolConfig getWorkerThreadPoolConfig(Map<String, Object> properties) {
        if (properties.containsKey(GrizzlyClientProperties.WORKER_THREAD_POOL_CONFIG)) {
            ...
            if (threadPoolConfig instanceof com.pdd.pop.ext.glassfish.tyrus.client.ThreadPoolConfig) {
                com.pdd.pop.ext.glassfish.tyrus.client.ThreadPoolConfig clientThreadPoolConfig =
                        (com.pdd.pop.ext.glassfish.tyrus.client.ThreadPoolConfig) threadPoolConfig;
                ...
                LOGGER.log(Level.CONFIG, String.format(
                        ...
                        com.pdd.pop.ext.glassfish.tyrus.client.ThreadPoolConfig.class.toString()));
            }
        }
        return null;
    }
