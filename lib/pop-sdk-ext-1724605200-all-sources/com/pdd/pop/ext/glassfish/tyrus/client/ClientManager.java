...
import com.pdd.pop.ext.glassfish.tyrus.core.AnnotatedEndpoint;
import com.pdd.pop.ext.glassfish.tyrus.core.BaseContainer;
import com.pdd.pop.ext.glassfish.tyrus.core.ComponentProviderService;
import com.pdd.pop.ext.glassfish.tyrus.core.DebugContext;
import com.pdd.pop.ext.glassfish.tyrus.core.ErrorCollector;
import com.pdd.pop.ext.glassfish.tyrus.core.ReflectionHelper;
import com.pdd.pop.ext.glassfish.tyrus.core.TyrusEndpointWrapper;
import com.pdd.pop.ext.glassfish.tyrus.core.TyrusFuture;
import com.pdd.pop.ext.glassfish.tyrus.core.TyrusSession;
...
public class ClientManager extends BaseContainer implements WebSocketContainer {
     ...
     *
     * @deprecated please use {@link com.pdd.pop.ext.glassfish.tyrus.client.ClientProperties#HANDSHAKE_TIMEOUT}.
     */
     ...
     *
     * @deprecated please use {@link com.pdd.pop.ext.glassfish.tyrus.client.ClientProperties#RECONNECT_HANDLER}.
     */
    @SuppressWarnings("UnusedDeclaration")
     ...
     * @deprecated please use {@link com.pdd.pop.ext.glassfish.tyrus.client.ClientProperties#PROXY_URI}.
     */
    @SuppressWarnings("UnusedDeclaration")
     ...
     *
     * @see javax.websocket.ClientEndpointConfig#getUserProperties()
     * @deprecated please use {@link com.pdd.pop.ext.glassfish.tyrus.client.ClientProperties#PROXY_HEADERS}.
     */
    @SuppressWarnings("UnusedDeclaration")
     ...
     * <p>
     * Value is expected to be either {@code com.pdd.pop.ext.glassfish.grizzly.ssl.SSLEngineConfigurator} when configuring Grizzly
     * client or {@link com.pdd.pop.ext.glassfish.tyrus.client.SslEngineConfigurator} when configuring JDK client.
     * <p>
     ...
     * </pre>
     *
     * @deprecated please use {@link com.pdd.pop.ext.glassfish.tyrus.client.ClientProperties#SSL_ENGINE_CONFIGURATOR}.
     */
    @SuppressWarnings("UnusedDeclaration")
    public static final String SSL_ENGINE_CONFIGURATOR = ClientProperties.SSL_ENGINE_CONFIGURATOR;

    /**
     * Default {@link com.pdd.pop.ext.glassfish.tyrus.spi.ServerContainerFactory} class name.
     * <p>
     * Uses Grizzly as transport implementation.
     */
    private static final String CONTAINER_PROVIDER_CLASSNAME =
            "com.pdd.pop.ext.glassfish.tyrus.container.grizzly.client.GrizzlyClientContainer";
