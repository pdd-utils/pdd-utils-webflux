...
import com.pdd.pop.ext.glassfish.tyrus.core.CloseReasons;
import com.pdd.pop.ext.glassfish.tyrus.core.TyrusUpgradeResponse;
import com.pdd.pop.ext.glassfish.tyrus.core.Utils;
...
import com.pdd.pop.ext.glassfish.grizzly.filterchain.Filter;
...
import com.pdd.pop.ext.glassfish.grizzly.http.HttpClientFilter;
...
import com.pdd.pop.ext.glassfish.grizzly.http.HttpServerFilter;
import com.pdd.pop.ext.glassfish.grizzly.http.Method;
import com.pdd.pop.ext.glassfish.grizzly.http.Protocol;
 ...
 * redirects it to appropriate connection ({@link com.pdd.pop.ext.glassfish.tyrus.core.TyrusEndpointWrapper}, {@link
 * com.pdd.pop.ext.glassfish.tyrus.core.TyrusWebSocket}) for processing.
 *
...
class GrizzlyClientFilter extends BaseFilter {
    ...
    private static final Attribute<com.pdd.pop.ext.glassfish.tyrus.spi.Connection> TYRUS_CONNECTION =
     ...
     * com.pdd.pop.ext.glassfish.tyrus.core.TyrusWebSocket}, if yes - creates websocket handshake packet and send it to a server.
     ...
     * com.pdd.pop.ext.glassfish.tyrus.core.TyrusWebSocket}, if yes - tries to close the websocket gracefully (sending close frame)
     * and calls {@link com.pdd.pop.ext.glassfish.tyrus.core.TyrusWebSocket#onClose(com.pdd.pop.ext.glassfish.tyrus.core.frame.CloseFrame)}. If
    ...
    public NextAction handleClose(FilterChainContext ctx) throws IOException {
        ...
        final com.pdd.pop.ext.glassfish.tyrus.spi.Connection connection = TYRUS_CONNECTION.get(ctx.getConnection());
        if (connection != null) {
     ...
     * com.pdd.pop.ext.glassfish.tyrus.core.TyrusWebSocket} object (websocket connection), we check if websocket handshake has been
     * completed for this connection, if not - initiate/validate handshake. If handshake has been completed - parse
     * websocket {@link com.pdd.pop.ext.glassfish.tyrus.core.frame.Frame}s one by one and pass processing to appropriate {@link
     * com.pdd.pop.ext.glassfish.tyrus.core.TyrusWebSocket}: {@link com.pdd.pop.ext.glassfish.tyrus.core.TyrusEndpointWrapper} for server- and
    ...
    public NextAction handleRead(FilterChainContext ctx) throws IOException {
        ...
        final com.pdd.pop.ext.glassfish.tyrus.spi.Connection tyrusConnection = TYRUS_CONNECTION.get(grizzlyConnection);
    ...
    private NextAction handleHandshake(final FilterChainContext ctx, HttpContent content) {
        ...
        ClientEngine.ClientUpgradeInfo clientUpgradeInfo = engine.processResponse(
                ...
                grizzlyWriter,
                new com.pdd.pop.ext.glassfish.tyrus.spi.Connection.CloseListener() {
                    @Override
        ...
        com.pdd.pop.ext.glassfish.tyrus.spi.Connection tyrusConnection;
        ...
        final String ATTR_NAME = "com.pdd.pop.ext.glassfish.tyrus.container.grizzly.WebSocketFilter.HANDSHAKE_PROCESSED";
    ...
    private class CloseTask extends TaskProcessor.Task {
        private final com.pdd.pop.ext.glassfish.tyrus.spi.Connection connection;
        private final CloseReason closeReason;
        private final Connection grizzlyConnection;

        private CloseTask(com.pdd.pop.ext.glassfish.tyrus.spi.Connection connection, CloseReason closeReason,
