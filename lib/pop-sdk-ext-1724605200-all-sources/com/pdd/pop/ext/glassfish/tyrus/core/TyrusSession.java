...
import com.pdd.pop.ext.glassfish.tyrus.core.cluster.DistributedSession;
import com.pdd.pop.ext.glassfish.tyrus.core.cluster.RemoteSession;
import com.pdd.pop.ext.glassfish.tyrus.core.cluster.SessionEventListener;
...
public class TyrusSession implements Session, DistributedSession {
     ...
     * {@link com.pdd.pop.ext.glassfish.tyrus.core.TyrusWebSocketEngine#PARALLEL_BROADCAST_ENABLED}
