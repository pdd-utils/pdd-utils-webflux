...
import com.pdd.pop.ext.glassfish.tyrus.core.Handshake;
import com.pdd.pop.ext.glassfish.tyrus.core.HandshakeException;
import com.pdd.pop.ext.glassfish.tyrus.core.MaskingKeyGenerator;
import com.pdd.pop.ext.glassfish.tyrus.core.ProtocolHandler;
import com.pdd.pop.ext.glassfish.tyrus.core.RequestContext;
import com.pdd.pop.ext.glassfish.tyrus.core.TyrusEndpointWrapper;
import com.pdd.pop.ext.glassfish.tyrus.core.TyrusExtension;
import com.pdd.pop.ext.glassfish.tyrus.core.TyrusWebSocket;
import com.pdd.pop.ext.glassfish.tyrus.core.Utils;
import com.pdd.pop.ext.glassfish.tyrus.core.Version;
import com.pdd.pop.ext.glassfish.tyrus.core.WebSocketException;
...
public class TyrusClientEngine implements ClientEngine {
    ...
    /**
     * Create {@link com.pdd.pop.ext.glassfish.tyrus.spi.WebSocketEngine} instance based on passed {@link WebSocketContainer} and
     ...
     * @param properties              passed container properties, see {@link com.pdd.pop.ext.glassfish.tyrus.client *
