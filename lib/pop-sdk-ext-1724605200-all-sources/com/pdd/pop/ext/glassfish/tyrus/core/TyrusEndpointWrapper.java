...
import com.pdd.pop.ext.glassfish.tyrus.core.cluster.BroadcastListener;
import com.pdd.pop.ext.glassfish.tyrus.core.cluster.ClusterContext;
import com.pdd.pop.ext.glassfish.tyrus.core.cluster.RemoteSession;
import com.pdd.pop.ext.glassfish.tyrus.core.coder.CoderWrapper;
import com.pdd.pop.ext.glassfish.tyrus.core.coder.InputStreamDecoder;
import com.pdd.pop.ext.glassfish.tyrus.core.coder.NoOpByteArrayCoder;
import com.pdd.pop.ext.glassfish.tyrus.core.coder.NoOpByteBufferCoder;
import com.pdd.pop.ext.glassfish.tyrus.core.coder.NoOpTextCoder;
import com.pdd.pop.ext.glassfish.tyrus.core.coder.PrimitiveDecoders;
import com.pdd.pop.ext.glassfish.tyrus.core.coder.ReaderDecoder;
import com.pdd.pop.ext.glassfish.tyrus.core.coder.ToStringEncoder;
...
import com.pdd.pop.ext.glassfish.tyrus.core.frame.TyrusFrame;
...
public class TyrusEndpointWrapper {
    ...
    private TyrusEndpointWrapper(Endpoint endpoint, Class<? extends Endpoint> endpointClass,
        ...
        if (clusterContext != null) {
            clusterContext
                    .registerSessionListener(getEndpointPath(), new com.pdd.pop.ext.glassfish.tyrus.core.cluster.SessionListener() {
                        @Override
     ...
     *                          {@link com.pdd.pop.ext.glassfish.tyrus.core.TyrusWebSocket}. The {@link
     *                          com.pdd.pop.ext.glassfish.tyrus.core.TyrusEndpointWrapper.SessionCallable} also handles extensions,
     *                          if any.
    ...
    /**
     * Serialize dataframe and send it to {@link com.pdd.pop.ext.glassfish.tyrus.core.TyrusWebSocket}.
     *
     * @param webSocket {@link com.pdd.pop.ext.glassfish.tyrus.core.TyrusWebSocket} instance used for sending the frame.
     ...
     * Session listener.
     * <p>
     * TODO: rename/consolidate with {@link com.pdd.pop.ext.glassfish.tyrus.core.monitoring.EndpointEventListener}?
     */
    public abstract static class SessionListener {

        /**
         * Result of {@link com.pdd.pop.ext.glassfish.tyrus.core.TyrusEndpointWrapper.SessionListener#onOpen(TyrusSession)}.
         */
         ...
         * com.pdd.pop.ext.glassfish.tyrus.core.TyrusEndpointWrapper.SessionListener.OnOpenResult#SESSION_ALLOWED}.
         *
         * @param session session to be opened.
         * @return {@link com.pdd.pop.ext.glassfish.tyrus.core.TyrusEndpointWrapper.SessionListener.OnOpenResult#SESSION_ALLOWED}
