...
public abstract class ServerContainerFactory {
    ...
    private static final String CONTAINTER_CLASS =
            "com.pdd.pop.ext.glassfish.tyrus.container.grizzly.server.GrizzlyServerContainer";

    /**
     * Create new {@link com.pdd.pop.ext.glassfish.tyrus.spi.ServerContainer} with default configuration.
     *
     * @return new {@link com.pdd.pop.ext.glassfish.tyrus.spi.ServerContainer}.
     */
    ...
    /**
     * Create new {@link com.pdd.pop.ext.glassfish.tyrus.spi.ServerContainer} with configuration.
     *
     ...
     * <p>
     * Has to be implemented by {@link com.pdd.pop.ext.glassfish.tyrus.spi.ServerContainerFactory} implementations.
     *
     * @param properties configuration passed to created server container.
     * @return new {@link com.pdd.pop.ext.glassfish.tyrus.spi.ServerContainer}.
     */
