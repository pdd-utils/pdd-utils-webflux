...
public abstract class ClusterContext {
     ...
     * {@link com.pdd.pop.ext.glassfish.tyrus.spi.ServerContainerFactory#createServerContainer(java.util.Map)}.
     */
    public static final String CLUSTER_CONTEXT = "com.pdd.pop.ext.glassfish.tyrus.core.cluster.ClusterContext";
     ...
     *                     invoked.
     * @see com.pdd.pop.ext.glassfish.tyrus.core.cluster.SessionEventListener
     */
     ...
     * <p>
     * Gets notification about session creation {@link com.pdd.pop.ext.glassfish.tyrus.core.cluster
     * .SessionListener#onSessionOpened(String)} and destruction {@link com.pdd.pop.ext.glassfish.tyrus.core.cluster
     * .SessionListener#onSessionClosed(String)}.
     *
     * @param endpointPath endpoint path identifying sessions alignment to the endpoint.
     * @param listener     listener instance.
     * @see com.pdd.pop.ext.glassfish.tyrus.core.cluster.SessionListener
     */
     ...
     * @param endpointPath endpoint path identifying sessions alignment to the endpoint.
     * @param listener     listener instance.
     * @see com.pdd.pop.ext.glassfish.tyrus.core.cluster.BroadcastListener
     */
